...
from dex.api.v2 import api_pb2 as api__pb2
...
class DexStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListClients = channel.unary_unary(
                '/api.Dex/ListClients',
                request_serializer=api__pb2.ListClientReq.SerializeToString,
                response_deserializer=api__pb2.ListClientResp.FromString,
                _registered_method=True)
...
def add_DexServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListClients': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=api__pb2.ListClientReq.FromString,
                    response_serializer=api__pb2.ListClientResp.SerializeToString,
            ),
...
class Dex(object):
    ...
    def ListClients(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/api.Dex/ListClients',
            api__pb2.ListClientReq.SerializeToString,
            api__pb2.ListClientResp.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
