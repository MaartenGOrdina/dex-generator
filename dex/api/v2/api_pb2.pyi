...
class ClientInfo(_message.Message):
    __slots__ = ("id", "redirect_uris", "trusted_peers", "public", "name", "logo_url")
    ID_FIELD_NUMBER: _ClassVar[int]
    REDIRECT_URIS_FIELD_NUMBER: _ClassVar[int]
    TRUSTED_PEERS_FIELD_NUMBER: _ClassVar[int]
    PUBLIC_FIELD_NUMBER: _ClassVar[int]
    ...
    name: str
    logo_url: str
    def __init__(self, id: _Optional[str] = ..., redirect_uris: _Optional[_Iterable[str]] = ..., trusted_peers: _Optional[_Iterable[str]] = ..., public: bool = ..., name: _Optional[str] = ..., logo_url: _Optional[str] = ...) -> None: ...
...
class ListClientReq(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class ListClientResp(_message.Message):
    __slots__ = ("clients",)
